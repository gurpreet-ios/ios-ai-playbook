...
> *Continuing the Part 3 spine ([`sample-apps/music-interview-app`](../sample-apps/music-interview-app)). Full disclosure: the bug below is not invented for the book — it shipped in this book's own sample app, generated by a capable model, and survived until someone ran the app. That is the point of this section.*
