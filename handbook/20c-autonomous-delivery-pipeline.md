...
- **S5 — code review** is the Level-4 reviewer in [`claude-autonomy.yml`](../.github/workflows/claude-autonomy.yml): it reviews the diff against `AGENTS.md` and the ADRs ([Chapter 14](14-code-review.md)), posts inline comments, and iterates on review replies — with a human as the final approver at **Gate B**, who owns what ships.
