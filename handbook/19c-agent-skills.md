# Chapter 19c: Packaging Workflows as Agent Skills
...
This playbook ships its skills in [`skills/`](../skills/README.md) — 8 installable conversions of the highest-leverage prompts, each mapped to the chapter that teaches it. Installation is a copy:
