---
title: "Chapter 11: iOS UI and Architecture"
---
...
> *Continuing the Part 3 spine ([`sample-apps/music-interview-app`](https://github.com/gurpreet-ios/ios-ai-playbook/tree/main/sample-apps/music-interview-app)). Chapter 9 gave us `PlayerViewModel`; this chapter puts a screen on it — and catches the AI's favorite rendering mistake.*
