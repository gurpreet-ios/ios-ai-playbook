...
Here is the full loop on a real screen — the Now Playing view from the Part 3 spine app ([`sample-apps/music-interview-app`](https://github.com/gurpreet-ios/ios-ai-playbook/tree/main/sample-apps/music-interview-app)). The shipped version is the *after*; this is how you get there from what the AI hands you first.
