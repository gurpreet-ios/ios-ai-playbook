---
title: "Chapter 12: iOS Data and Concurrency"
---
...
> *Continuing the Part 3 spine ([`sample-apps/music-interview-app`](https://github.com/gurpreet-ios/ios-ai-playbook/tree/main/sample-apps/music-interview-app)). This chapter is where the architecture meets the compiler: the offline-downloads feature, and a data race Swift 6 refuses to build.*
