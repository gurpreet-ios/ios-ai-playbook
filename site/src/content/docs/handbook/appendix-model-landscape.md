---
title: "Appendix: The Model Landscape"
---
...
When you update this table: change the date above, and check that chapter references still hold ([Ch 3](/handbook/03-context-engineering/) context windows, [Ch 28](/handbook/28-rag-and-custom-agents/) embeddings and tool calling, [Ch 29](/handbook/29-llm-deployment-architecture/) deployment tiers).
