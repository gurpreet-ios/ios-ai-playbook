---
title: "Chapter 22: AI-Native Documentation"
---
...
### The "Rules" File
Every repository must have root rule definitions. While this used to be a single file, it's often a combination of an `AGENTS.md` and modular tool-specific directories (like `.cursor/rules/*.mdc`). This acts as the permanent system prompt for any agent that touches your codebase. Maintain the content once and mirror it into whichever filenames your team's tools read; nothing rots trust faster than rules that disagree. (For a deep dive, see **[Chapter 19b: Structuring Agent Rules](/handbook/19b-structuring-agent-rules/)**).
